...
└── README.md       # 项目文档
👥 团队分工
组员 A: 负责模块 1 - 用户注册与登录系统。

组员 B: 负责模块 2 - 断点续传与全局日志系统。

组员 C: 负责模块 3 - 虚拟文件表的设计与升级。

组员 D: 负责模块 4 - 秒传算法及物理存储管理。

组员 E: 负责模块 5 - 多点下载逻辑优化。

组员 F: 负责项目集成测试与整体文档编写。
